-- Credito Salute SQ - Crea funzione registrazione scontrino e verifica
-- Incolla ed esegui TUTTO questo file in Supabase SQL Editor.
-- Alla fine deve comparire: funzioni_trovate = 1
