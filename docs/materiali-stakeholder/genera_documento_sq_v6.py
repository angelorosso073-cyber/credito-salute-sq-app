...
ST = {
    ...
    "bullet":_S("bullet",fontName=FONT_BODY, fontSize=10.5, leading=15,
                 textColor=GRIGIO, leftIndent=26, bulletIndent=16,
                 spaceBefore=2, spaceAfter=3),
    "bul_b": _S("bul_b",fontName=FONT_BOLD, fontSize=10.5, leading=15,
                 textColor=BLU,   leftIndent=26, bulletIndent=16,
                 spaceBefore=2, spaceAfter=3),
    "bul_w": _S("bul_w",fontName=FONT_BODY, fontSize=10,   leading=15,
                 textColor=BIANCO,leftIndent=24, bulletIndent=14,
                 spaceBefore=2, spaceAfter=3),
...
def PB(bullet, text, s):
    """Bulleted paragraph: bullet hangs at bulletIndent, text (first line and
    wrapped lines alike) starts flush at leftIndent — keeps wrapped words
    aligned with the word above instead of with the bullet."""
    return Paragraph(text, ST[s] if isinstance(s, str) else s, bulletText=bullet)
...
def build_story():
    ...
    story += [
        ...
        TwoColBox(
            left_items=[
                PB("❌", "Gadget che nessuno usa", "bullet"),
                PB("❌", "Volantini dimenticati il giorno dopo", "bullet"),
                PB("❌", "Calendari appesi e poi gettati", "bullet"),
                PB("❌", "Nessun ritorno misurabile", "bullet"),
                SP(0.2),
                P("<b>Risultato: budget speso, fidelizzazione zero.</b>", "body_l"),
            ],
            right_items=[
                PB("✔", "Credito reale su cure infermieristiche", "bul_b"),
                PB("✔", "Accumulato con acquisti già abituali", "bul_b"),
                PB("✔", "Cedibile a chiunque il cliente voglia", "bul_b"),
                PB("✔", "Report periodico con dati reali", "bul_b"),
                SP(0.2),
    ...
    formula_l = [
        SP(0.1),
        PB("•", "<b>15%</b> della spesa valida → Credito Salute SQ", "bullet"),
        PB("•", "1 euro SQ = 1 euro di sconto sulle prestazioni", "bullet"),
        PB("•", "Cedibile a chiunque, senza vincoli di parentela", "bullet"),
        PB("•", "Fondo fisso all'avvio: zero costi variabili per l'esercizio", "bullet"),
    ]
    formula_r = GradBox([
    ...
    story += [
        ...
        PB("•", "Quanti clienti si iscrivono e con quale velocità", "bullet"),
        PB("•", "Quanto credito accumulano e in che tempi", "bullet"),
        PB("•", "Quali prestazioni scelgono con maggiore frequenza", "bullet"),
        SP(0.35),
        GradBox([
    ...
    cta_l = GradBox([
        ...
        PB("1.", "Contatta Salute Quotidiana", "bul_w"),
        PB("2.", "Definisci fondo e durata",   "bul_w"),
        PB("3.", "Firma il contratto",         "bul_w"),
        PB("4.", "Avvia il programma",         "bul_w"),
    ], BLU, BLU_XD, width=cta_w, py=0.45*cm)
    cta_r = GradBox([
        P("PER IL PARTNER / FINANZIATORE", "label_w"), SP(0.12),
        PB("1.", "Richiedi i risultati del pilot",      "bul_w"),
        PB("2.", "Valuta l'estensione del modello",     "bul_w"),
        PB("3.", "Definisci l'accordo di partnership",  "bul_w"),
